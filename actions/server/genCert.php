...
HTML;
                printHeader("Create and Sign Certificate", $inhead);

?>


	<div class='sectionWide'>
		<h2 class='title'>Create and Sign Certificate</h2>
		<div>
			<p><p>Create a new certificate signed by this CA.</p>
			<p>Enter the <strong>Fully Qualified Server Name</strong> exmaple: www.example.com<br>
			The other fields are optional </p></p>
		</div>
	
                  <form id='csrInputForm' action='index.php?type=server&action=createCert' method='post' class='shadow wideForm' name="GenReqForm" onSubmit="return GenReq();">
